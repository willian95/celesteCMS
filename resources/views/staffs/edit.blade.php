            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Editar Staff
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
            ...
            methods:{
                ...
                update(){
                    ...
                    if(this.pictureStatus != "subiendo"){
                            ...
                            this.loading = true
                            axios.post("{{ url('/staffs/update') }}", {name:this.name, image: this.finalPictureName, id: this.staffId, mainImageFileType: this.mainImageFileType, job: this.job}).then(res => {
                                this.loading = false
                                if(res.data.success == true){

                                    swal({
                                        title: "Excelente!",
                                        text: "Staff actualizado!",
                                        icon: "success"
                                    }).then(function() {
