                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="staff in staffs">
                                    ...
                                    <td>
                                        <img :src="staff.image" alt="" style="width: 100%;">
                                        {{--<video style="width: 100%;" controls v-else>
                                            <source :src="blog.image" type="video/mp4">
                                        </video>--}}
                                    </td>
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/') }}'+'/staffs/edit/'+staff.id"><i class="far fa-edit"></i></a>
                                        <button class="btn btn-secondary" @click="erase(staff.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            methods:{
                ...
                erase(id){
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            this.loading = true
                            axios.post("{{ url('/staffs/delete/') }}", {id: id}).then(res => {
                                this.loading = false
                                if(res.data.success == true){
                                    swal({
                                        title: "Genial!",
                                        text: "Staff eliminado!",
                                        icon: "success"
                                    });
                                    this.fetch()
                                }else{
