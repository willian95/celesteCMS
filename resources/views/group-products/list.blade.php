        ...
        <div class="card card-custom">
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Proyectos de Grupo Teza
                </div>
                <div class="card-toolbar">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="{{ route('group-product.create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="product in products">
                                ...
                                <td>
                                    <img :src="product.main_image" alt="" style="width: 50%;">
                                </td>
                                <td>
                                    <a class="btn btn-info" :href="'{{ url('/') }}'+'/products/group/edit/'+product.id"><i class="far fa-edit"></i></a>
            ...
            fetch(page) {
                ...
                axios.get(url)
                    .then(res => {
                        ...
                        this.totalPages = res.data.projects.last_page

                        this.products = res.data.projects.data
            ...
            erase(id) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            this.loading = true
                            axios.post("{{ url('/products/delete/') }}", {
                                id: id
                            }).then(res => {
                                this.loading = false
